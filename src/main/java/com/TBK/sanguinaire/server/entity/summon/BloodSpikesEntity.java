package com.TBK.sanguinaire.server.entity.summon;
...
public class BloodSpikesEntity extends Entity implements TraceableEntity {
    ...
    private int delay = 0;
    public BloodSpikesEntity(EntityType<?> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }
    public BloodSpikesEntity(Level pLevel, double pX, double pY, double pZ, float pYRot, int pWarmupDelay, LivingEntity pOwner){
        this(SGEntityType.BLOOD_SPIKES.get(),pLevel);
